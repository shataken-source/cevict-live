# SmokersRights Banner Assets

This folder contains banner images for SmokersRights in multiple standard ad sizes.
...
- Use brand colors: Blue (#2563eb) and Purple (#9333ea)
- Include "SmokersRights" branding
