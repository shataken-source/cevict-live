...
const features: PlanFeature[] = [
  ...
  { name: 'Win Rate & Stats', free: true, pro: true, enterprise: true },
  { name: 'Real-time Market Data', free: false, pro: true, enterprise: true },
  { name: 'Kalshi API Integration', free: false, pro: true, enterprise: true },
  { name: 'Polymarket Integration', free: false, pro: true, enterprise: true },
  { name: 'Advanced Risk Metrics', free: false, pro: true, enterprise: true },
  { name: 'Kelly Criterion Calculator', free: false, pro: true, enterprise: true },
  { name: 'AI Trading Insights', free: false, pro: '50/month', enterprise: 'Unlimited' },
  { name: 'Arbitrage Scanner', free: false, pro: true, enterprise: true },
  { name: 'Arbitrage Alerts', free: false, pro: true, enterprise: true },
  { name: 'SMS/Email Alerts', free: false, pro: true, enterprise: true },
  { name: 'Arbitrage Execution', free: false, pro: false, enterprise: true },
