...
exports.MassagerClient = void 0;
class MassagerClient {
    constructor() {
     ...
     */
    async calculateArbitrage(odds1, odds2, totalStake = 100) {
     ...
     */
    async calculateHedge(initialStake, initialOdds, currentOdds) {
     ...
     */
    async calculateKelly(winProbability, odds, bankroll) {
     ...
     */
    async runMonteCarlo(winProbability, numSimulations = 10000) {
        const p = winProbability / 100;
     ...
     * Analyze value bet
     */
    async analyzeValue(myProbability, marketOdds) {
     ...
     */
    async getImpliedProbability(odds) {
        const decimal = this.americanToDecimal(odds);
        const impliedProb = (1 / decimal) * 100;
     ...
     */
    async generate250Strategy(bankroll, riskTolerance) {
...
exports.MassagerClient = MassagerClient;
//# sourceMappingURL=massager-client.js.map