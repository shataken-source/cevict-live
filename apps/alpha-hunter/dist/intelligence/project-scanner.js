...
class ProjectScanner {
    ...
    async scanForOpportunities(news) {
        const opportunities = [];
    ...
    async analyzeProjectOpportunities(project, news) {
        const opportunities = [];
        ...
        if (monetizationOpp)
            opportunities.push(monetizationOpp);
        return opportunities;
    }
    createProjectOpportunity(project, news) {
        const actionMap = {
            sports: [
    ...
    analyzeMonetizationPotential(project) {
    ...
    async getDailyProjectSuggestion() {
