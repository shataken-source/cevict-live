-- COMPLETE FIX: Update bot_config AND add missing categories
-- This fixes both the $50 config issue and missing "derivatives" category

-- ============================================
-- PART 1: Force update bot_config to $1000
-- ============================================
-- First, let's see what's currently there
SELECT 
  config_key,
  config_value,
  config_value->>'dailySpendingLimit' as current_limit,
  updated_at
FROM bot_config
WHERE config_key = 'trading';

-- Now update it - using jsonb_set with create_missing = true
UPDATE bot_config
SET 
...
-- ============================================
-- PART 2: Update ALL existing strategy params
-- ============================================
...
-- ============================================
-- PART 3: Create/Update ALL categories including "derivatives"
-- ============================================
