...
if (-not (Test-Path $envFile)) {
    Write-Host "⚠️  WARNING: .env.local not found at $envFile" -ForegroundColor Yellow
...
if ($service.Status -eq 'Running') {
    Write-Host "`n✅ SERVICE INSTALLED AND RUNNING!" -ForegroundColor Green
    ...
    Write-Host "`n✅ The bot will now:" -ForegroundColor Green
    ...
    Write-Host "`n⚠️  Service installed but not running. Status: $($service.Status)" -ForegroundColor Yellow
