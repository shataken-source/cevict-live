/**
 * AdSense Utility Functions for Progno
 *
...
export function shouldShowAds(pathname: string): boolean {
  ...
  // Allow ads on content pages (home, vegas-analysis, create-prediction, arbitrage, etc.)
  return true;
}
 ...
 */
export function checkPageContent(): boolean {
