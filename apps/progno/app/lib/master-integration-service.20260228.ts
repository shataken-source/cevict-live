...
export class MasterIntegrationService {
  ...
  constructor(initialBankroll: number = 10000) {
    ...
    this.environmentalFactors = new EnvironmentalFactorsService(process.env.CEVICT_SCRAPER_URL, process.env.CEVICT_SCRAPER_API_KEY || process.env.SCRAPER_API_KEY);
  }
