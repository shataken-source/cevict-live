-- Part 1: Schema (Tables, Indexes, Views)
...
ALTER TABLE progno_predictions ADD COLUMN IF NOT EXISTS result TEXT;
ALTER TABLE progno_predictions ADD COLUMN IF NOT EXISTS profit NUMERIC;
ALTER TABLE progno_predictions ADD COLUMN IF NOT EXISTS odds_at_prediction NUMERIC;
