      ...
      <header className="fixed top-0 left-0 right-0 z-50 border-b border-white/5 bg-[#0a0e17]/80 backdrop-blur-md">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-6">
            ...
            <Link
              href="/sign-up"
              className="text-sm font-medium bg-amber-500 hover:bg-amber-400 text-[#0a0e17] px-4 py-2 rounded-lg transition"
            >
              Start free trial
            </Link>
            <Link
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-6 hover:border-cyan-500/20 transition">
              ...
              <p className="text-slate-400 text-sm">
                Get SMS or email when a site goes down or a bot breaks. Configure alerts and
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-6 flex flex-col">
              ...
              <p className="text-slate-400 text-sm mb-6">Best for trying out or a couple of sites.</p>
              <ul className="space-y-3 text-sm text-slate-300 mb-8 flex-1">
                <li className="flex items-center gap-2">
                  <Check className="w-4 h-4 text-cyan-400 shrink-0" /> Up to 2 websites
                </li>
                <li className="flex items-center gap-2">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-6 flex flex-col">
              ...
              <p className="text-slate-400 text-sm mb-6">Up to 25 sites and power-user features.</p>
              <ul className="space-y-3 text-sm text-slate-300 mb-8 flex-1">
                <li className="flex items-center gap-2">
                  <Check className="w-4 h-4 text-cyan-400 shrink-0" /> Up to 25 websites
                </li>
                <li className="flex items-center gap-2">
                  <Check className="w-4 h-4 text-cyan-400 shrink-0" /> Checks every 1 minute
                </li>
                ...
                <li className="flex items-center gap-2 text-slate-400 text-xs mt-2">
                  If you need more websites, contact sales.
                </li>
              </ul>
              <Link
                href="/"
