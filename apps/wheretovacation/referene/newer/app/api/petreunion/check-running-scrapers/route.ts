...
// Simple in-memory tracker (in production, use Redis or database)
// This tracks active scraper sessions
const activeScrapers = new Map<string, { startTime: number; type: string }>();
