        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="space-y-3">
            <div className="bg-slate-700 rounded-lg p-3">
              ...
              <div className="text-2xl font-semibold">{battery.voltage}V</div>
            </div>
            <div className="bg-slate-700 rounded-lg p-3">
              <div className="text-sm text-slate-400">Current</div>
              <div className={`text-2xl font-semibold ${battery.current < 0 ? 'text-red-400' : 'text-emerald-400'}`}>
                {battery.current > 0 ? '+' : ''}{battery.current}A
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="bg-slate-700 rounded-lg p-3">
              ...
              <div className="text-2xl font-semibold text-emerald-400">{battery.health}%</div>
            </div>
            <div className="bg-slate-700 rounded-lg p-3">
              <div className="text-sm text-slate-400">Charge Cycles</div>
              <div className="text-2xl font-semibold">{battery.cycles}</div>
            </div>
            <div className="bg-slate-700 rounded-lg p-3">
              <div className="text-sm text-slate-400">Temperature</div>
              <div className="text-2xl font-semibold">{battery.temperature}°F</div>
            </div>
          </div>
        </div>
