...
import { CheckCircle2, Clock, Heart, Loader2, Mail, MapPin, Phone, Search, TrendingUp, User } from '@/components/ui/icons';
  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok && data.success) {
        ...
        const baseMessage = (typeof data?.error === 'string' && data.error) ? data.error : 'Failed to search for your pet';
