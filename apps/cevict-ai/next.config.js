...
const nextConfig = {
  // Environment: use NEXT_PUBLIC_ENV if set (e.g. test.cevict.ai = test), else prod build = production, dev = test
  env: {
    NEXT_PUBLIC_ENV: process.env.NEXT_PUBLIC_ENV || (process.env.NODE_ENV === 'production' ? 'production' : 'test')
  },
